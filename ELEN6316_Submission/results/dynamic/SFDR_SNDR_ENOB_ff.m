...
csvFiles = [
    "DAC_Output_Spectrum_J017ff.csv"
    "DAC_Output_Spectrum_J127ff.csv"
    "DAC_Output_Spectrum_J251ff.csv"
    "DAC_Output_Spectrum_J503ff.csv"
    "DAC_Output_Spectrum_J751ff.csv"
    "DAC_Output_Spectrum_J997ff.csv"
];
...
ylabel('Magnitude (dB)');
title('DAC Output Spectrum, ff Corner');
...
title('ff Corner: SFDR and SNDR vs Input Frequency');
...
xlabel('Input Frequency (MHz)');
ylabel('ENOB (bits)');
title('ff Corner: ENOB vs Input Frequency');