...
csvFiles = [
    "DAC_Output_Spectrum_J017ss.csv"
    "DAC_Output_Spectrum_J127ss.csv"
    "DAC_Output_Spectrum_J251ss.csv"
    "DAC_Output_Spectrum_J503ss.csv"
    "DAC_Output_Spectrum_J751ss.csv"
    "DAC_Output_Spectrum_J997ss.csv"
];
...
ylabel('Magnitude (dB)');
title('DAC Output Spectrum, ss Corner');
...
title('ss Corner: SFDR and SNDR vs Input Frequency');
...
xlabel('Input Frequency (MHz)');
ylabel('ENOB (bits)');
title('ss Corner: ENOB vs Input Frequency');